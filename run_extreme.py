...
import os
import torch
from exp.exp_extreme import Exp_Extreme
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=True, default='extreme', help='model id')
    ...
    parser.add_argument('--model_save_path', type=str, default='/root/autodl-tmp-extreme/checkpoints/', help='path to save model')
    parser.add_argument('--results_save_path', type=str, default='/root/autodl-tmp-extreme/results/', help='path to save results')
    parser.add_argument('--test_results_save_path', type=str, default='/root/autodl-tmp-extreme/test_results/', help='path to save test results')
    ...
    parser.add_argument('--loss', type=str, default='MHWMSE', help='loss function')
