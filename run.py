...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='dataset/oisst_16grid.npy', help='data file')
    ...
    parser.add_argument('--enc_in', type=int, default=1, help='输入特征维度，SST通常为1')
